...
setting the output voltage (the same resistor the forum thread swaps to
move between PB-3's 2.0V and PB-S5's 2.4V targets). Its behavioral model
stands in for the buck stage in `kicad/pb3-replacement.cir`, described in
the circuit design and emulation step.
