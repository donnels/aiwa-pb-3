...
`kicad/pb3-architecture-sizing.cir`, described in the circuit design and
emulation step (Stage 1).
...
* https://stereo2go.com/forums/threads/rechargeable-battery-replacement-for-aiwa-pb-3-pb-4.9025/[Stereo2Go forum thread] —
  the original community teardown and battery-replacement research this
  project builds on.
* https://github.com/kitspace/awesome-electronics[awesome-electronics] —
  ...
  references for reading the ICs cited above.
