...
setting the output voltage (the same resistor the forum thread swaps —
100kΩ for the PB-S5 clone's 2.4V default, 120kΩ for 2.1V — to move the
output). Its behavioral model stands in for the buck stage in
