...
* Constraints: OEM wall wart is missing, OEM PB-3 pack is dead, and donor geometry comes only from shared photos of clone packs. Reverse engineering starts with images, not physical SLA references.
